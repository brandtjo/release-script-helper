...
public class ProjectLevelComponent {
    ...
    private static class MyListPanel extends AddEditDeleteListPanel<String> {
        ...
        private @Nullable String showEditDialog(final String initialValue) {
            return Messages.showInputDialog(this, myQuery, "Entry", Messages.getQuestionIcon(), initialValue, new InputValidatorEx() {
                @Override
                public boolean checkInput(String inputString) {
                    return StringUtils.isNotBlank(inputString) && inputString.matches("\\w+");
                }
