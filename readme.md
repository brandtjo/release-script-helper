...
`(timestamp)_[(ticket-type)(ticket-number)_](description).(suffix)`

The user is guided by a small creation dialog, allowing him to opt out of using a ticket system, or defining ticket type, number and description.
